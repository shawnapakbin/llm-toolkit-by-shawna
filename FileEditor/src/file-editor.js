...
exports.MoveFileSchema =
  exports.DeleteFileSchema =
  exports.ListDirectorySchema =
  exports.SearchFilesSchema =
  exports.WriteFileSchema =
  exports.ReadFileSchema =
    void 0;
...
async function searchFiles(input, workspaceRoot) {
  const searchDir = input.directory
    ? path_1.default.resolve(workspaceRoot, input.directory)
    : workspaceRoot;
  const results = [];
