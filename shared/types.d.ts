 ...
 */
export declare function createSuccessResponse<T>(data: T, timingMs?: number, traceId?: string): ToolResponse<T>;
/**
 * Create a failed tool response.
 */
export declare function createErrorResponse(errorCode: ErrorCode, errorMessage: string, timingMs?: number, traceId?: string): ToolResponse;
